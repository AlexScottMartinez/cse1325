...
Mainwin::Mainwin() : store{nullptr}, display{new Gtk::Label{}}, filename{"untitled.manga"} {
    ...
    insert_customer = Gtk::manage(new Gtk::ToolButton(*customer_image));
    ...
    insert_order = Gtk::manage(new Gtk::ToolButton(*order_image));
    ...
    insert_customer = Gtk::manage(new Gtk::ToolButton(*tool_image));
    ...
    insert_plant = Gtk::manage(new Gtk::ToolButton(*plant_image));
    ...
    insert_mulch = Gtk::manage(new Gtk::ToolButton(*mulch_image));
    ...
    view_customer = Gtk::manage(new Gtk::ToolButton(*view_customer_image));
    ...
    view_order = Gtk::manage(new Gtk::ToolButton(*view_order_image));
    view_order->set_tooltip_markup("View all customers");
...
void Mainwin::on_view_orders_click() {
    std::string o = "<tt><u>Current Orders</u>\n";
